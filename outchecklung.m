...
%legend('venous','mean arterial','arterial')
%title('blood oxygen conc v. r')
%subplot(2,1,2),plot(r,cair  ,'.')
%legend('inspired','mean alveolar','alveolar')
%title('air oxygen conc v. r')
%figure(3)
%plot(r,Pressures,'.')
%legend('venous partial','mean arterial','mean alveolar','inspired','arterial','alveoli')
%title('oxygen partial pressures v. r')
